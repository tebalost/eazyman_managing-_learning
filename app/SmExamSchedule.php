...
class SmExamSchedule extends Model
{
    ...
    public static function assignedRoutine($class_id, $exam_id, $subject_id, $exam_period_id){
        try {
            return SmExamSchedule::where('class_id', $class_id)->where('exam_term_id', $exam_id)->where('subject_id', $subject_id)->where('exam_period_id', $exam_period_id)->first();
        } catch (\Exception $e) {
            $data=[];
            return $data;
        }
    ...
    public static function assignedRoutineSubject($class_id, $exam_id, $subject_id){
    ...
    public static function examScheduleSubject($class_id, $exam_id, $exam_period_id, $date){
