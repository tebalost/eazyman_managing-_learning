...
class SmAssignSubject extends Model
{
    ...
    public static function getNumberOfPartStream($subject_id, $class_id, $exam_term_id)
    {
        try {
            $results = SmExamSetup::where([
                ['class_id', $class_id],
    ...
    public static function getMarksOfPartStream($student_id, $subject_id, $class_id, $exam_term_id)
    {
        try {
            $results = SmMarkStore::where([
                ['student_id', $student_id],
    ...
    public static function getNumberOfSubjects($class_id, $section_id)
    {
        try {
    ...
    public static function getSumMark($student_id, $subject_id, $class_id, $section_id, $exam_term_id)
    {
        try {
            ...
            if(!empty($getMark)){
                //Get Exam Setup ID to get the exam mark
                $exam_setup_id=$getMark->exam_setup_id;
                $getExamMark= SmExamSetup::where('id',$exam_setup_id)->first();
                $results=round(($getMark->total_marks/100)*$getExamMark->exam_mark,0);
            }else{
                $results= '0';
            }
    ...
    public static function getSumMarkStream($student_id, $subject_id, $class_id, $exam_term_id)
    {
        try {
            $getMark = SmMarkStore::where([
                ['student_id', $student_id],
