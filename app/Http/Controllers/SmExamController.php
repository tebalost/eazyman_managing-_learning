...
class SmExamController extends Controller
{
    ...
    /**
     *
     * Display exam belong the single teacher
     */
    public function teacherExams(){
        //Thing to get from db
        /*
         * exam title, class, section , subject, Total mark, mark distribution
         */
...
//        }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            [
                'class_ids' => 'required',
                'record_marks_cut_off_date' => 'required',
                'record_marks_cut_off_time' => 'required',
            ...
            [
                ...
                'record_marks_cut_off_date.required' => 'The last day to record marks is required!',
                'record_marks_cut_off_time.required' => 'The cut-off time to record marks is required!',
                ...
                foreach ($sections as $section) {
                    ...
                    foreach ($request->subjects_ids as $subject_id) {
                        if (in_array($subject_id, $eligible_subjects)) {
                            ...
                            $exam->record_marks_cut_off_date =  date_format(date_create($request->record_marks_cut_off_date), "Y-m-d");
                            $exam->record_marks_cut_off_time = $request->record_marks_cut_off_time;
                            ...
                            for ($i = 0; $i < $length; $i++) {
                                ...
                                $newSetupExam->record_marks_cut_off_date = date_format(date_create($request->record_marks_cut_off_date), "Y-m-d");
                                $newSetupExam->record_marks_cut_off_time = $request->record_marks_cut_off_time;
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $exam->school_id = Auth::user()->school_id;
            $exam->academic_id = getAcademicId();
            $exam->exam_type_id = $exam_term_id;
