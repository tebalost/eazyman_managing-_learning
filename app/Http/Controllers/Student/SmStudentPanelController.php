...
class SmStudentPanelController extends Controller
{
    ...
    public function studentProfileUpdate(Request $request, $id = null)
    {
        try {
            ...
            return view('backEnd.studentPanel.my_profile_update', compact('student', 'classes', 'religions', 'blood_groups', 'genders', 'route_lists', 'vehicles', 'dormitory_lists', 'categories','groups', 'sessions', 'siblings', 'driver_lists','orphans','sponsors'));
        } catch (\Exception $e) {
            dd($e);
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
