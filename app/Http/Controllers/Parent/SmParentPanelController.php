...
class SmParentPanelController extends Controller
{
    ...
    public function UpdatemyChildren($id)
    {
        ...
        try {
            ...
            return view('backEnd.parentPanel.update_my_children', compact('student', 'classes', 'religions', 'blood_groups', 'genders', 'route_lists', 'vehicles', 'dormitory_lists', 'categories','groups', 'sessions', 'siblings', 'driver_lists','sponsors','orphans'));
        } catch (\Exception $e) {
