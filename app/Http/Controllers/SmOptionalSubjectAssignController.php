...
class SmOptionalSubjectAssignController extends Controller
{
    ...
    public function assignOptionalSubjectSearch(Request $request)
    {
        ...
        public function assignOptionalSubjectStore(Request $request){
            ...
            try {
                if ($request->student_id != '') {
                    SmOptionalSubjectAssign::where('section_id','=',$request->section_id)->where('class_id', '=', $request->class_id)->where('subject_id','=',$request->subject_id)->where('session_id','=',getAcademicId())->delete();
                ...
                foreach ($request->student_id as  $student) {
                    $student_info=SmStudent::where('id','=',$student)->first();
                        ...
                        $optional_subject->class_id=$student_info->class_id;
                        $optional_subject->section_id=$student_info->section_id;
