    ...
    public function viewStaff($id)
    {
        ...
        try {
            ...
            if (!empty($staffDetails)) {
                ...
                return view('backEnd.humanResource.viewStaff', compact('staffDetails', 'staffPayrollDetails', 'staffLeaveDetails', 'staffDocumentsDetails', 'timelines', 'teacherStudentsSubjects'));
            } else {
    ...
    public function printStaff($id)
    {
        ...
        try {
            ...
            if (!empty($staffDetails)) {
                ...
                return view('backEnd.humanResource.printStaff', compact('staffDetails', 'staffPayrollDetails', 'staffLeaveDetails', 'staffDocumentsDetails', 'timelines', 'teacherStudentsSubjects'));
            } else {
                Toastr::error('Something went wrong, please try again', 'Failed');
                return redirect()->back();
            }
