...
//                    'is_registration_permission' => SmRegistrationSetting::where('registration_permission',1)->first(),
    ...
    public function about()
    {
        try {
            ...
            $totalSchools = SmSchool::where('active_status', 1)->get();
            ...
            return view('frontEnd.home.light_about', compact('exams', 'classes', 'subjects', 'exams_types', 'sections', 'about', 'testimonial', 'totalStudents', 'totalTeachers', 'totalSchools', 'history', 'mission'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
    ...
    public function registration()
    {
        try {
            ...
            $academic_years = SmAcademicYear::where('active_status', '=', 1)->where('school_id', '1')->get();//Serumula School
            return view('frontEnd.home.registration', compact('schools','academic_years', 'genders','classes'));
        }catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
