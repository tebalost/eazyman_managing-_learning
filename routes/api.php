...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::get('system-details','SmApiController@systemDetails');
    Route::get('module','SmApiController@activeModules');
    ...
    //EazyMan AppAttendance
    Route::get('class-attendance/{id}/{month}/{year}/', 'SmApiController@classAttendanceApi');
    ...
    //Eazymoola
    Route::get('get-user-account/{id}', ['as' => 'get_user_account', 'uses' => 'SmApiController@getUserAccount']);
    Route::post('topup-eazymoola-account', ['as' => 'topup_eazymoola_account', 'uses' => 'SmApiController@topUpUserWallet']);
    Route::get('eazymoola-providers', ['as' => 'get_user_account', 'uses' => 'SmApiController@getEazyMoolaProviders']);
    Route::post('scratch-card-topup', ['as' => 'scratch_card_topup', 'uses' => 'SmApiController@getEazyMoolaScratchCardTopUp']);
    Route::get('advance-me/{id}/{amount}', ['as' => 'advance_me', 'uses' => 'SmApiController@advanceMe']);
    Route::post('request-loan', ['as' => 'request_loan', 'uses' => 'SmApiController@requestLoan']);

    //Student Applications
    Route::get('get-schools', ['as' => 'get_schools', 'uses' => 'SmApiController@getSchools']);
    Route::get('get-schools-classes/{school_id}', ['as' => 'get_classes', 'uses' => 'SmApiController@getSchoolClasses']);
    Route::post('save-student-application', ['as' => 'save_student_application', 'uses' => 'SmApiController@storeStudentApplication']);

    // Transport registration
    Route::post('store-transport','SmApiController@transportstore');

    //Mentoring
    Route::get('mentor-menu','SmApiController@mentorMenu');
    Route::get('mentor-trainer','SmApiController@mentorTrainer');
    Route::get('mentor-classes','SmApiController@mentorClasses');

    //Student Attendance
    Route::get('mark-attendance/{class_id}/{section_id}','SmApiController@markAttendance');
    Route::post('store-class-attendance','SmApiController@studentAttendanceStore');
    Route::get('view-attendance/{class_id}/{section_id}/{date}','SmApiController@viewAttendance');

    //Time-Table
    Route::get('time-table/{id}','SmApiController@TimeTable');
    Route::get('class-timetable/{id}','SmApiController@classTimeTable');
    Route::get('exam-timetable/{id}/{class_id}','SmApiController@examTimeTable');

    // Dormitory register
    Route::post('register-dormitory','SmApiController@registerDormitory');
    ...
    Route::get('student-subject-homework/{id}/{subject_id}', 'SmApiController@studentHomeworkSubject');
    ...
    //***************USER MENU AND LANDING PAGE*************************//
    Route::get('get-user-menu/{id}', 'SmApiController@userMenuApi');
    Route::get('app-landing-page', 'SmApiController@userLandingMenuApi');
    Route::get('user-menu/{id}', 'SmApiController@userMenuDetails');

    //**************My Profile, Marks Recording and Workspace Staging********************
    Route::get('my-profile/{id}', 'SmApiController@getProfile');
    Route::get('user-profile/{id}', 'SmApiController@userProfile');
    Route::post('my-subjects-staging', 'SmApiController@mySubjectStagingApi');
    Route::post('subject-marks-recording','SmApiController@mySubjectRecordMarksApi');
    Route::post('get-subject-students','SmApiController@mySubjectStudentsApi');
    Route::post('student-subject-attendance','SmApiController@mySubjectAttendanceApi');
    Route::post('save-subject-attendance','SmApiController@mySubjectAttendanceStore');
    Route::post('save-student-marks','SmApiController@mySubjectMarksStore');
    //******************Start Student Panel ********************


    Route::get('my-subjects/{id}', 'SmApiController@mySubjectApi');
    ...
    Route::get('subject-exam-result/{id}/{subject_id}', 'SmApiController@examListSubjectApi');
    ...
    Route::get('get-notifications-count/{id}', 'SmApiController@notificationApi');
    Route::get('get-notifications-details/{id}', 'SmApiController@notificationDetailsApi');
    Route::post('notification-update', 'SmApiController@notificationsUpdateApi');
    ...
    Route::post('student-payment-summary', 'SmApiController@studentFeesPaymentSummary');
    Route::any('school/{school_id}/student-fees-payment', 'SmApiController@saas_studentFeesPayment');

    //Lesson Plan
    Route::get('lesson-plan/{id}', 'SmApiController@myLessonApi');
    Route::get('add-lesson/{id}/{class_id}/{subject_id}', 'SmApiController@addLessonPlanApi');
    Route::get('lesson-overview/{id}/{class_id}/{subject_id}', 'SmApiController@lessonPlanOverViewApi');
    Route::post('save-lesson-plan', 'SmApiController@saveLessonPlan');
    Route::post('lesson-plan-class-allocation', 'SmApiController@assignLessonPlan');
    Route::post('save-plan-class-allocation', 'SmApiController@saveLessonPlanAssign');
    Route::post('save-lesson-plan-class', 'SmApiController@saveLessonPlanAssign');
    Route::get('view-lesson-plan/{lesson_id}', 'SmApiController@viewLessonPlan');//Students
});
