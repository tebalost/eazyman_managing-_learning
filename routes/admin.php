...
Route::group(['middleware' => ['XSS','subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        //fees payment store
        Route::post('fees-payment-store', 'SmFeesController@feesPaymentStore')->name('fees-payment-store')->middleware();
        ...
        Route::get('receipt-print/{id}/{group}', ['as' => 'receipt_print', 'uses' => 'SmFeesController@feesPaymentReceiptPrint']);

        Route::get('fees-payment-quotation-print/{id}/{group}', ['as' => 'fees_payment_quotation_print', 'uses' => 'SmFeesController@feesPaymentQuotationPrint']);
        ...
        Route::get('class-report-print/{class_id}/{section_id}', ['as' => 'class_report_print', 'uses' => 'SmAcademicsController@classReportPrint']);
        ...
        Route::get('mark-sheet-report-all/print/{exam_id}/{class_id}/{section_id}', ['as' => 'mark_sheet_report_print_all', 'uses' => 'SmExaminationController@markSheetReportStudentPrintAll']);
        ...
        Route::get('mark-sheet-report-student-comment', ['as' => 'mark_sheet_report_student_comment', 'uses' => 'SmExaminationController@markSheetReportStudentComment'])->middleware('userRolePermission:390');
        Route::post('mark-sheet-report-student-comment', ['as' => 'mark_sheet_report_student_comment', 'uses' => 'SmExaminationController@markSheetReportStudentCommentSearch']);
        Route::post('mark-sheet-report-student-comment-store', ['as' => 'mark_sheet_report_student_comment_store', 'uses' => 'SmExaminationController@studentReportsComments']);
        ...
        // Results Configurations --- Assumed the right of Pass grades to avoid creating new rules
        // Route::resource('results-configuration', 'SmResultsConfigurationsController')->middleware('userRolePermission:225');
        Route::get('results-configuration', 'SmResultsConfigurationsController@index')->name('results-configuration')->middleware('userRolePermission:225');
        Route::post('results-configuration', 'SmResultsConfigurationsController@store')->name('results-configuration')->middleware('userRolePermission:226');
        Route::get('results-configuration/{id}', 'SmResultsConfigurationsController@show')->name('results-configuration-edit')->middleware('userRolePermission:227');
        Route::put('results-configuration/{id}', 'SmResultsConfigurationsController@update')->name('results-configuration-update')->middleware('userRolePermission:227');
        Route::delete('results-configuration/{id}', 'SmResultsConfigurationsController@destroy')->name('results-configuration-delete')->middleware('userRolePermission:228');
        ...
        Route::get('pass-definition', 'SmExaminationController@passDefinition')->name('pass-definition')->middleware('userRolePermission:209');
        Route::post('pass-definition-store', 'SmExaminationController@passDefinitionStore')->name('pass-definition-store')->middleware('userRolePermission:209');
        Route::get('pass-definition-update/{id}', 'SmExaminationController@passDefinitionUpdate')->name('pass-definition-update')->middleware('userRolePermission:228');
        Route::delete('pass-definition-delete/{id}', 'SmExaminationController@passDefinitionDestroy')->name('pass-definition-delete')->middleware('userRolePermission:228');
        ...
        Route::get('exam-results-analysis', ['as' => 'exam_results_analysis', 'uses' => 'SmReportController@exam_results_analysis']) ;
        Route::post('exam-results-analysis', ['as' => 'exam_results_analysis', 'uses' => 'SmReportController@exam_results_analysis_search']);
        ...
        Route::post('send-marks-by-sms-process', ['as' => 'send_marks_by_sms_process', 'uses' => 'SmExaminationController@sendMarksBySmsProcess'])->middleware('userRolePermission:227');

        // Block/Unblock Results
        Route::get('block-results', ['as' => 'block_results', 'uses' => 'SmExaminationController@blockResults'])->middleware('userRolePermission:229');
        Route::post('block-results-store', ['as' => 'block_results_store', 'uses' => 'SmExaminationController@blockResultsStore'])->middleware('userRolePermission:227');
        Route::post('block-results-process', ['as' => 'block_results_process', 'uses' => 'SmExaminationController@blockResultsProcess'])->middleware('userRolePermission:227');
        ...
        //EazyMoola Topup
        Route::post('student-eazymoola-topup', ['as' => 'student_eazymoola_topup', 'uses' => 'SmEazymoolaController@studentEazyMoolaTopup']);
        ...
        Route::get('tabulation-sheet-report-stream', ['as' => 'tabulation_sheet_report_stream', 'uses' => 'SmReportController@tabulationSheetReport'])->middleware('userRolePermission:391');
        Route::post('tabulation-sheet-report-stream', ['as' => 'tabulation_sheet_report_stream', 'uses' => 'SmReportController@tabulationSheetReportSearch']);
        Route::get('student-report-comments', ['as' => 'student_report_comments', 'uses' => 'SmReportController@studentReportComments']);
        Route::post('tabulation-sheet/print', 'SmReportController@tabulationSheetReportPrint')->name('tabulation-sheet/print');
        Route::post('results-analysis/print', 'SmReportController@resultsAnalysisPrint')->name('results-analysis/print');
        Route::post('tabulation-sheet-stream/print', 'SmReportController@tabulationSheetReportStreamPrint')->name('tabulation-sheet-stream/print');
        ...
        Route::get('print-staff/{id}', ['as' => 'printStaff', 'uses' => 'SmStaffController@printStaff']);
        ...
        //Pass List
        Route::get('pass-list', ['as' => 'pass_list', 'uses' => 'PassListController@index']);
        Route::post('pass-list', ['as' => 'pass_list', 'uses' => 'PassListController@search']);
        ...
        Route::put('issue-books/{id}', 'SmBookController@issueupdate')->name('issue-books-update');
        Route::delete('issue-books/{id}', 'SmBookController@destroy')->name('issue-books-delete');
        ...
        Route::post('update-school-opening-date', 'SmSystemSettingController@updateSchoolOpeningDate')->name('update-school-opening-date')->middleware('userRolePermission:406');
        ...
        Route::get('student-subjects-report', 'SmReportController@studentSubjectsReportIndex')->name('student-subjects-report')->middleware('userRolePermission:388');
        Route::get('student-subjects-report/print/{class}/{section}', 'SmReportController@studentSubjectsReportPrint')->name('student-subjects-report-print');
        Route::get('student-subjects-report-validation/print/{class}/{section}', 'SmReportController@studentSubjectsReportPrintValidation')->name('student-subjects-report-print-validation');
        Route::post('student-subjects-list', 'SmReportController@studentSubjectsReport')->name('student-subjects-list');
        ...
        Route::get('find-students/{subject}/{section}/{class}', 'teacher\SmTeacherPanelController@studentDetailsSearch')->name('studentDetailsSearch');
