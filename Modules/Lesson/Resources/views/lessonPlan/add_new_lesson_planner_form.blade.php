            ...
            <div class="col-lg-12">  
                ...
                <div class="row mt-25">
                    ...
                    <div class="col-lg-4" id="select_topic_div">
                        ...
                        <div class="pull-right loader" id="select_topic_loader" style="margin-top: -30px;padding-right: 21px;"> </div>
                ...
                <div class="row mt-25">
                    <div class="col-lg-6 mt-30-md">                       
                         ...
                         <label id="teacher_label" class="top20">@lang('lang.lecture') @lang('lang.youtube') @lang('lang.url')  ( @lang('lang.multiple')  @lang('lang.url') @lang('lang.separate') @lang('lang.by') @lang('lang.comma')(,))</label>
