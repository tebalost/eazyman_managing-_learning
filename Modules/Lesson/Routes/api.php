...
Route::prefix('lesson')->group(function () {
    Route::get('/', 'SmLessonAPIController@index')->name('lesson');
    Route::post('/create-store', 'AjaxController@getSubject')->name('lesson.create-store');
    Route::get('lesson', 'SmLessonAPIController@addLesson')->name('lesson.addLesson');
    Route::post('lesson', 'SmLessonAPIController@storeLesson')->name('lesson.storelesson');
