...
if (isset($setting->copyright_text)) {
    ...
    generalSetting()->copyright_text = 'Copyright © {{$year}}  All rights reserved | Serumula Business Solutions';
}
...
if (empty($login_background)) {
    $css = "background: url(" . url('public/backEnd/img/in_registration.jpg') . ")  no-repeat center; background-size: cover; ";
} else {
...
<body class="reg_bg" style="background: url({{url('public/backEnd/img/in_registration.jpg')}});">
    <style>
    ...
    <section class="login-area  registration_area ">
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-12">
                    <div class="text-center white-box single_registration_area">
                        <div class="reg_tittle mt-10 mb-10">
                            <h2>@lang('lang.student') @lang('lang.school') @lang('lang.application')</h2>
                        </div>
                        <div class="reg_tittle mt-10">
                            <h5>@lang('lang.student') @lang('lang.info')</h5>
                        </div>
                            <form method="POST" class="" action="#" id="parent-registration">{{--url('/student-store')--}}
                               {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="primary-input" type="text" name='first_name' id="school_name" placeholder="student first Name *" value="{{old('first_name')}}" />
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="primary-input" type="text" name='last_name' id="school_name" placeholder="stduent last Name *" value="{{old('student_email')}}" />
                                        <span class="focus-border"></span>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                {{-- <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input placeholder="Date Of Birth *" class="primary-input mydob" type="text"  value="{{old('date_of_birth')}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="primary-input" type="email" name='student_email' id="student_email" placeholder="student email" value="{{old('student_email')}}"/>
                                        <span class="focus-border"></span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="primary-input" type="text" name='student_mobile' id="student_mobile" placeholder="student Mobile" value="{{old('student_mobile')}}" />
                                        <span class="focus-border"></span>
                                    </div>
                                ...
                                <div class="col-lg-6 no-gutters input-right-icon">
                                        ...
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderFileOneName" placeholder="Previous School Results"
                                                   readonly="">
                                            <span class="focus-border"></span>
                                            @if ($errors->has('file'))
                            ...
                            <div class="mt-40">
                             ...
                             <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="primary-input" type="text" name='guardian_name' id="school_name" placeholder="Guardian Name *" value="{{old('guardian_name')}}" />
                                        <span class="focus-border"></span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="primary-input" type="text" name='guardian_email' id="guardian_email" placeholder="Guardian Email *" value="{{old('guardian_email')}}"/>
                                        <span class="focus-border"></span>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="primary-input" type="text" name='guardian_mobile' id="guardian_mobile" placeholder="Guardian  Mobile *" value="{{old('guardian_mobile')}}"/>
                                        <span class="focus-border"></span>
                                    </div>
                             ...
                             <div class="row mt-20">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group input-group">
                                        <textarea class="primary-input" name='how_do_know_us' id="school_name" placeholder="How do you know us.?">{{old('how_do_know_us')}}</textarea>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
