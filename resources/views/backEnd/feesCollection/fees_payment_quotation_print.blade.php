...
.footer .footer_widget .copyies_text{
  ...
  <body onLoad="loadHandler();">
      ...
      <table class="custom_table">
        ...
        <tbody>
        <tr><td colspan="2"><h3>@lang('lang.fees') @lang('lang.quotation')</h3></td></tr>
            <tr>
              <!-- first header  -->
                <th>fees Details</th>
                <th>Amount</th>
        ...
        @foreach($fees_assigneds as $fees_assigned)
             ...
             {{-- @if ($p_amount>0) --}}
                <td class="border-top">
                  {{-- {{'fine: '.$fine}} --}}
                    ...
                    {{@number_format($assigned_main_fees, 2, '.', ', ')}}
                    @if ($discount_amount>0)
                      <br>
          ...
          <tr>
            ...
            <td style="text-align: right">
              ...
              <strong> {{ number_format((float) $totalquote, 2, '.', ', ')}} </strong>
             </td>
