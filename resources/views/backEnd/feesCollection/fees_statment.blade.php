                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        @foreach($fees_assigneds as $fees_assigned)
                            ...
                            @php
                                $grand_total += $fees_assigned->feesGroupMaster->amount+$fine;
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                @php
                                    $rest_amount = $fees_assigned->feesGroupMaster->amount - $total_paid+$fine;
                            ...
                            <td>
                               {{@$fees_assigned->feesGroupMaster->amount+$fine}}
                            </td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td> {{$discount_amount}}  ({{generalSetting()->currency_symbol}})</td>
                            <td>{{$fine}}  ({{generalSetting()->currency_symbol}})</td>
                            <td>{{$paid}}  ({{generalSetting()->currency_symbol}})</td>
                            <td>
                                @php 
                        ...
                        <tr>
                            ...
                            <td>@if(in_array($fees_discount->id, $applied_discount))
                                ...
                                @endphp
                                <a href="#" data-toggle="tooltip" data-placement="right" title="{{'Collected By: '.@$created_by}}">Discount of ({{generalSetting()->currency_symbol}}){{@$fees_discount->feesDiscount->amount}} </a>
                                
                                @else
                                @lang('lang.discount_of')  ({{generalSetting()->currency_symbol}}){{$fees_discount->feesDiscount !=""?$fees_discount->feesDiscount->amount:""}} @lang('lang.assigned')
                                @endif
                            </td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th></th>
                            <th>{{$grand_total}}  ({{generalSetting()->currency_symbol}})</th>
                            <th></th>
                            <th></th>
                            <th></th>
