...
@section('mainContent')
@php  $setting = App\SmGeneralSettings::find(Auth::user()->school_id); if(!empty($setting->currency_symbol)){ $currency = $setting->currency_symbol; }else{ $currency = '$'; } @endphp
                                ...
                                <tr>
                                    ...
                                    <td><div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item deletePayment" data-toggle="modal" href="#" id="{{$fees_payment->id}}" data-id="{{$fees_payment->id}}" data-target="#deleteFeesPayment">@lang('lang.delete')</a>

                                                <a class="dropdown-item" href="{{route('fees_collect_student_wise', [$fees_payment->student_id])}}">@lang('lang.view')</a>
                                                @if($fees_payment->slip != "")

                                                <a class="dropdown-item" href="{{route('bank-slip-view',getFilePath3(@$fees_payment->slip))}}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <h4>@lang('lang.are_you_sure_to_delete'), Please Verify this by entering the <b>Payment ID</b> Below</h4>
                </div>
                ...
                <div class="mt-40 d-flex justify-content-between">
                    ...
                    <div class="input-effect" style="width: 50%">
                    <input class="primary-input" type="text" value="" name="id" required id="fee_payment_id">
                    <label>@lang('lang.verify') @lang('lang.payment') @lang('lang.id')</label>
                    <span class="focus-border"></span>
                    </div>


                    <button style="float: right" class="primary-btn fix-gr-bg" type="submit">@lang('lang.delete')</button>
