                        ...
                        <table  class="display school-table school-table-style" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @if(count($exam_attendance_childs) == 0)
                                    ...
                                    <tr>
                                        <td>{{@$student->last_name.' '.@$student->first_name}}<input type="hidden" name="id[]" value="{{@$student->id}}"></td>
                                ...
                                @else
                                    ...
                                    <tr>
                                        <td>{{@$student->studentInfo !=""?@$student->studentInfo->last_name.' '.@$student->studentInfo->first_name:""}}<input type="hidden" name="id[]" value="{{@$student->student_id}}"></td>
                                        <td>{{@$student->studentInfo !=""?@$student->studentInfo->admission_id_number:""}}</td>
                                        <td>
                                            <div class="d-flex radio-btn-flex">
                                                <div class="mr-20">
