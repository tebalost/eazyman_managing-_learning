                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input date form-control{{ $errors->has('cut_off_date') ? ' is-invalid' : '' }}" id="startDate" type="text"
                                                   name="record_marks_cut_off_date" value="{{isset($exam)? $exam->record_marks_cut_off_date: ''}}" autocomplete="off" id="cut_off_date">
                                            <label>@lang('lang.cut_off_date') *</label>
                                            <span class="focus-border"></span>
                                            @if ($errors->has('cut_off_date'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('cut_off_date') }}</strong>
                                            </span>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="row no-gutters input-right-icon mt-25">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input time  form-control{{ @$errors->has('end_time') ? ' is-invalid' : '' }}" type="text" name="record_marks_cut_off_time"  value="{{isset($exam)? $exam->record_marks_cut_off_time: ''}}">
                                            <label>@lang('lang.record') @lang('lang.marks') @lang('lang.end_time') *</label>
                                            <span class="focus-border"></span>
                    ...
                    @php $count =1 ; @endphp
                                ...
                                <tr>
                                   ...
                                   <td>
                                    ...
                                    <td>{{$exam->record_marks_cut_off_date}} {{$exam->record_marks_cut_off_time}}</td>
                                    <td>
                                        <div class="dropdown">
