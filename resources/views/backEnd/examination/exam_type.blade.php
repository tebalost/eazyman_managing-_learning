                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row mt-25">
                                    ...
                                    <div class="col-lg-12 mt-30-md">
                                        <select class="w-100 bb niceSelect form-control {{ $errors->has('quarter') ? ' is-invalid' : '' }}" id="quarter" name="quarter">
                                            <option data-display=" @lang('lang.quarter') *" value="">@lang('lang.quarter') *</option>
                                ...
                                <div class="row mt-25">
                                    ...
                                    <div class="col-lg-12 mt-30-md">
                                        <select class="w-100 bb niceSelect form-control {{ $errors->has('is_examination') ? ' is-invalid' : '' }}" id="is_examination" name="is_examination">
                                            <option data-display=" @lang('lang.is_examination') *" value="">@lang('lang.is_examination') *</option>
                                            <option value="1"> @lang('lang.yes')</option>
                                            <option value="0"> @lang('lang.no')</option>
                                        </select>
                                        @if ($errors->has('active_status'))
                                        <span class="invalid-feedback invalid-select" role="alert">
                                                <strong>{{ $errors->first('is_examination') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                ...
                                @if(isset($exam_type_edit))
                                <div class="row mt-25">
                                    <label class="col-lg-12 mt-30-md" for="quarter">@lang('lang.exam_quarter')</label>
                                    <div class="col-lg-12 mt-30-md">
                                        <select class="w-100 bb niceSelect form-control {{ $errors->has('quarter') ? ' is-invalid' : '' }}" id="quarter" name="quarter">
                                            <option data-display=" @lang('lang.quarter') *" value="">@lang('lang.quarter') *</option>
                                            <option value="ONE" {{ (@$exam_type_edit->quarter =='ONE') ? 'selected' :''}}>1</option>
                                            <option value="TWO" {{ (@$exam_type_edit->quarter =='TWO') ? 'selected' :''}}>2</option>
                                            <option value="THREE" {{ (@$exam_type_edit->quarter =='THREE') ? 'selected' :''}}>3</option>
                                            <option value="FOUR" {{ (@$exam_type_edit->quarter =='FOUR') ? 'selected' :''}}>4</option>
                                        </select>
                                        @if ($errors->has('quarter'))
                                        <span class="invalid-feedback invalid-select" role="alert">
                                                <strong>{{ $errors->first('quarter') }}</strong>
                                ...
                                @if(isset($exam_type_edit))
                                <div class="row mt-25">
                                    <label class="col-lg-12 mt-30-md" for="quarter">@lang('lang.status')</label>
                                    <div class="col-lg-12 mt-30-md">
                                ...
                                @if(isset($exam_type_edit))
                                <div class="row mt-25">
                                    <label class="col-lg-12 mt-30-md" for="is_examination">@lang('lang.is_examination')</label>
                                        <div class="col-lg-12 mt-30-md">

                                            <select class="w-100 bb niceSelect form-control {{ $errors->has('is_examination') ? ' is-invalid' : '' }}" id="is_examination" name="is_examination">
                                                <option data-display=" @lang('lang.is_examination') *" value="">@lang('lang.is_examination') *</option>
                                                <option value="1" {{ (@$exam_type_edit->is_examination == 1) ? 'selected' :''}}> @lang('lang.yes')</option>
                                                <option value="0" {{ (@$exam_type_edit->is_examination == 0) ? 'selected' :''}}> @lang('lang.no')</option>
                                            </select>
                                            @if ($errors->has('is_examination'))
                                            <span class="invalid-feedback invalid-select" role="alert">
                                                <strong>{{ $errors->first('is_examination') }}</strong>
                                            </span>
                                            @endif
