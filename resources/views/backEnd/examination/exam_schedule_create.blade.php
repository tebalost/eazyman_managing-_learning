                        ...
                        <tr>
                            ...
                            @php
                             ...
                             //   $assigned_routine_subject = assignedRoutineSubject($class_id, $section_id, $exam_id, $assign_subject->subject_id);
                                ...
                                $assigned_routine = assignedRoutine($class_id, $exam_id, $assign_subject->subject_id, $exam_period->id);

                                $assigned_routine = App\SmExamSchedule::assignedRoutine($class_id, $exam_id, $assign_subject->subject_id, $exam_period->id);
