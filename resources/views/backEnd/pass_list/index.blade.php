...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.student_pass_list') </h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.examinations')</a>
                <a href="#">@lang('lang.student_pass_list')</a>
            </div>
        </div>
    </div>
</section>
<section class="admin-visitor-area">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
            <div class="white-box">
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'pass_list', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'pass_list']) }}
                <div class="row">
