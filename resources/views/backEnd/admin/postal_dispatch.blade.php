                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row no-gutters input-right-icon mt-35">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input" id="placeholderInput" type="text" placeholder="{{isset($postal_dispatch)? ($postal_dispatch->file != ""? getFilePath3($postal_dispatch->file):'File Name'):'File Name'}}" readonly>
                                            <span class="focus-border"></span>
                                               ...
                                               <a class="dropdown-item" data-toggle="modal" data-target="#deletePostalReceiveModal{{@$postal_dispatch->id}}"
                                                ...
                                                @endif
                                                  ...
                                                  @if (@file_exists($postal_dispatch->file))
                                                        <a class="dropdown-item" href="{{route('postal-dispatch-document',getFilePath3(@$postal_dispatch->file))}}">
