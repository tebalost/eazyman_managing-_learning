                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row no-gutters input-right-icon mt-35">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input" id="placeholderInput" type="text" placeholder="{{isset($postal_receive)? ($postal_receive->file != ""? getFilePath3($postal_receive->file):'File Name'):'File Name'}}" readonly>
                                            <span class="focus-border"></span>
                                            @if ($errors->has('file'))
                                                ...
                                                @endif
                                                  ...
                                                  @if(userPermission(31))
                                                    @if (@file_exists($postal_receive->file))
                                                        <a class="dropdown-item" href="{{route('postal-receive-document',getFilePath3(@$postal_receive->file))}}">
