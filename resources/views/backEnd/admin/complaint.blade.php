                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input" id="placeholderInput" type="text"
                                                       placeholder="{{isset($complaint)? ($complaint->file != ""? getFilePath3($complaint->file):'File Name'):'File Name'}}"
                                                       readonly>
                                                <span class="focus-border"></span>
                                                @if ($errors->has('file'))
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                   ...
                                                   @if (@file_exists($complaint->file))
                                                        <a class="dropdown-item"
                                                            href="{{route('download-complaint-document',getFilePath3(@$complaint->file))}}">
