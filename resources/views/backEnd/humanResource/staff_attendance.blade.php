...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                <a href="{{route('staff-attendance-import')}}" class="primary-btn small fix-gr-bg pull-right sm_mb_20 sm2_mb_20"><span class="ti-plus pr-2"></span>Import Attendance</a>
            </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
...
{{ Form::open(['class' => 'form-horizontal', 'files' => true, 'method' => 'POST', 'enctype' => 'multipart/form-data'])}}
            ...
            <div class="row mt-40">
                <div class="col-lg-12">
                    ...
                    @if(userPermission(166))

                    
                        <div class="col-lg-6 col-md-6 text-md-right">
                            <button type="submit" class="primary-btn fix-gr-bg mb-20" onclick="javascript: form.action='{{route('staff-attendance-store')}}'">
