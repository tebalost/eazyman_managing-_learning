              ...
              <div class="white-box">
                <div class="">
                    ...
                    <div class="row mb-30 mt-20">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        <select class="niceSelect w-100 bb form-control" name="marital_status">
                                            ...
                                            <option value="unmarried" {{$editData->marital_status == "single"? 'selected':''}}>@lang('lang.single')</option>
                                            <option value="widowed" {{$editData->marital_status  == 'widowed'? 'selected': ''}} >@lang('lang.widowed')</option>
                                            <option value="unmarried" {{$editData->marital_status  == 'divorced'? 'selected': ''}}>@lang('lang.divorced')</option>
                                            <option value="separated" {{$editData->marital_status  == 'separated'? 'selected': ''}}>@lang('lang.separated')</option>
                        ...
                        <div class="col-lg-3">
                         <div class="input-effect">
                             <input class="primary-input form-control{{ $errors->has('basic_salary')? ' is-invalid' : '' }}" type="number" step="0.01"  name="basic_salary" value="{{$editData->basic_salary}}">
                             <span class="focus-border"></span>
