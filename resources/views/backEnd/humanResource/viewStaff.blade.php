...
<div class="col-lg-9 staff-details">
    ...
    <ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#subjects" role="tab" data-toggle="tab">@lang('lang.subjects')</a>
        </li>
        <li class="nav-item">
        ...
        &nbsp;
        <li class="nav-item print-button d-flex align-items-center justify-content-end">
            <a href="{{route('printStaff',$staffDetails->id)}}" class="primary-btn small fix-gr-bg">@lang('lang.print')
            </a>
        </li>
    </ul>
...
{{$staffDetails->date_of_birth != ""? dateConvert($staffDetails->date_of_birth):''}}
    ...
    <div class="single-info">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7">
                <div class="">
                    @if(isset($staffDetails)){{$staffDetails->next_of_kin2}}@endif
                </div>
            </div>
        </div>
    </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <form action="record-marks" method="post" id="recordMarks">
                                        @csrf
                                        <input type="hidden" name="subject" value="{{@$teacherStudentsSubjectsRecord['subject']->id}}"/>
                                    </form>

                                    @if($teacherStudentsSubjectsRecord['can-record-marks'])
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="$('#recordMarks').submit();">@lang('lang.record_marks')</a>
                                    @endif
                                    <form action="find-students" method="post" id="viewStudents">
                                        @csrf
                                        <input type="hidden" name="subject" value="{{@$teacherStudentsSubjectsRecord['subject']->id}}"/>

                                    </form>
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="$('#viewStudents').submit();">@lang('lang.view')</a>
                                </div>
                            </div>
                        </td>
                    </tr>
