...
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid p-0">
        ...
        <div class="row">
                    ...
                    <div class="row mb-30">
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                                ...
                                <span class="focus-border"></span>
                                <label>@lang('lang.next_of_kin1')</label>
                                @if ($errors->has('next_of_kin1'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('next_of_kin1') }}</strong>
                                </span>
                                @endif
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="input-effect">
                                ...
                                <span class="focus-border"></span>
                                <label>@lang('lang.next_of_kin2')</label>
                                @if ($errors->has('next_of_kin2'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('next_of_kin2') }}</strong>
                                </span>
                                @endif
                            </div>
                        </div>
                ...
                <div class="col-lg-3">
                    <div class="input-effect">
                        <select class="niceSelect w-100 bb form-control" name="marital_status">
                            ...
                            <option {{old('marital_status') == 'single'? 'selected': ''}} value="single">@lang('lang.single')</option>
                            <option {{old('marital_status') == 'widowed'? 'selected': ''}} value="widowed">@lang('lang.widowed')</option>
                            <option {{old('marital_status') == 'divorced'? 'selected': ''}} value="unmarried">@lang('lang.divorced')</option>
                            <option {{old('marital_status') == 'separated'? 'selected': ''}} value="separated">@lang('lang.separated')</option>
                        </select>
                        <span class="focus-border"></span>
                    </div>
                </div>
            ...
            <div class="col-lg-3">
               <div class="input-effect">
                   <input class="primary-input form-control{{ $errors->has('basic_salary') ? ' is-invalid' : '' }}" type="number" step="0.01"  name="basic_salary" value="{{old('basic_salary')}}" autocomplete="off">
