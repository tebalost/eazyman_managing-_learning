                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input form-control" name="upload_file_name"
                                                       type="text"
                                                       placeholder="{{isset($editData->upload_image_file) && $editData->upload_image_file != ""? getFilePath3($editData->upload_image_file):'Attach File'}}"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        @if(userPermission(443))
                                                            <a class="deleteUrl dropdown-item"
                                                               ...
                                                               href="{{url('delete-holiday-view/'.$value->id)}}">@lang('lang.delete')</a>
                                                        @endif
                                                        @if($value->upload_image_file != "")
                                                            <a class="dropdown-item"
                                                               href="{{url('download-holiday-document/'.getFilePath3($value->upload_image_file))}}">
