        ...
        <div class="row">
            ...
            <div class="col-lg-8 pull-right mt-20">
                ...
                <div class="print_button pull-right">
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'tabulation-sheet/print',
                    ...
                    <div class="table-responsive">
                        <table class="mt-30 mb-20 table table-striped table-bordered ">
                            ...
                            <tr>
                                ...
                                $mark_parts = App\SmAssignSubject::getNumberOfPart($subject_ID, $class_id, $section_id,
                                $exam_term_id);
                                @endphp
                            ...
                            <tr>
                                ...
                                $subject_ID = $subject->subject_id;
                                $subject_Name = $subject->subject->subject_name;
                                $mark_parts = App\SmAssignSubject::getMarksOfPart($student->id, $subject_ID, $class_id,
                                ...
                                <td class="total">
                                    @php
                                    $tola_mark_by_subject = App\SmAssignSubject::getSumMark($student->id, $subject_ID,
                                    $class_id, $section_id, $exam_term_id);
                                    $marks_by_students = $marks_by_students + $tola_mark_by_subject;
                                    @endphp
                                    @if ($tola_mark_by_subject>0)
                                    @php
                                    $subjectsCount++;
                                     $average = round($marks_by_students/$subjectsCount,1);
                                    @endphp
                                ...
                                <td>
                                    @if( $average>=50)
                                    @php $result = "PASS"; @endphp
                                    @else
                                    @php $result = "FAIL"; @endphp
                                    @endif
                                    {{$result}}
                                </td>
