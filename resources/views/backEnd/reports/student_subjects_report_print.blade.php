...
<div class="container-fluid"> 
    ...
    <table width="100%">
        ...
        <tr style="padding: 0">
            ...
            <td style="padding-bottom: 0; padding-left: 0.1em; padding-top: 0; border-bottom:1px solid black"><strong><p style="text-align: left"> {{$student->last_name}} {{$student->first_name}}</p></strong></td>
            @foreach($subjects as $subject)
            @php
            ...
            <td style="padding-bottom: 0; padding-top: 0; border-bottom:1px solid black" colspan="{{count($mark_parts)}}" class="subject-list"></td>
            @endforeach
