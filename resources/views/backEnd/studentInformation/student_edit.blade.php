                ...
                <div class="white-box">
                    <div class="">
                        ...
                        <div class="row mb-20">
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect">
                                    <input type="hidden" name="admission_id_number" value="{{$student->admission_id_number}}">
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('sponsor') ? ' is-invalid' : '' }}" name="sponsor">
                                        ...
                                        <option value="{{$sponsor->id}}" {{$student->sponsor_id != ""? ($student->sponsor_id == $sponsor->id? 'selected':''):''}}>{{$sponsor->base_setup_name}}</option>
                                        }
                                        @endforeach
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('orphan') ? ' is-invalid' : '' }}" name="orphan">
                                        ...
                                        <option value="{{$orphan->id}}" {{$student->orphan_id != ""? ($student->orphan_id == $orphan->id? 'selected':''):''}}>{{$orphan->base_setup_name}}</option>
                                        }
                                        @endforeach
                            ...
                            <div class="row mb-20">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        ...
                                        <label>@lang('lang.guardian_email')</label>
                                        <span class="focus-border"></span>
