                ...
                <div class="white-box">
                    <div class="">
                        ...
                        <div class="row mb-40 mt-30">
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect">
                                    <input class="primary-input  form-control{{ $errors->has('admission_number') ? ' is-invalid' : '' }}" type="hidden" onkeyup="GetAdmin(this.value)" name="admission_number"
                                     value="{{$max_admission_id != ''? $max_admission_id + 1 : 1}}" >

                                    <input class="primary-input " type="text" readonly name="admission_id_number" value="{{$admission_id_number}}" >

                                   <label>@lang('lang.student') @lang('lang.number')</label>
                                    <span class="focus-border"></span>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('sponsor') ? ' is-invalid' : '' }}" name="sponsor">
                                        <option data-display="@lang('lang.sponsor')" value="">@lang('lang.sponsor')</option>
                                        @foreach($sponsors as $sponsor)
                                        <option value="{{$sponsor->id}}" {{old('sponsor') == $sponsor->id? 'selected': '' }}>{{$sponsor->base_setup_name}}</option>
                                        @endforeach
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('orphan') ? ' is-invalid' : '' }}" name="orphan">
                                        <option data-display="@lang('lang.orphan')" value="">@lang('lang.orphan')</option>
                                        @foreach($orphans as $orphan)
                                        <option value="{{$orphan->id}}" {{old('orphan') == $orphan->id? 'selected': '' }}>{{$orphan->base_setup_name}}</option>
                                        @endforeach
                                    ...
                                    <span class="invalid-feedback invalid-select" role="alert">
                                        <strong>{{ $errors->first('orphan') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row mb-40">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('lang.guardian') @lang('lang.email') </label>
                                        <span class="focus-border"></span>
