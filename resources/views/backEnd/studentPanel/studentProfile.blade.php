        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="main-title">
                    <h3 class="mb-20">@lang('lang.welcome') - {{@Auth::user()->school->school_name}} | <strong> {{@$student_detail->full_name}}</strong> </h3>
                </div> 
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="student-subject" class="d-block">
                ...
                @if(userPermission(3))
                <div class="col-lg-3 col-md-6">
                    <a href="student-noticeboard" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
                    ...
                    @if(userPermission(4))
                <div class="col-lg-3 col-md-6">
                    <a href="student-result" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="student-teacher" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
                ...
                @if(userPermission(7))
                <div class="col-lg-3 col-md-6">
                    <a href="student-library" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
