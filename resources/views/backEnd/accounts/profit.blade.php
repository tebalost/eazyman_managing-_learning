                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('lang.income') ({{generalSetting()->currency_symbol}})</th>
                                        <th>@lang('lang.expense') ({{generalSetting()->currency_symbol}})</th>
                                        <th>@lang('lang.profit') ({{generalSetting()->currency_symbol}})</th>
                                    </tr>
                                </thead>
                                <tbody>                                   
                                    <tr>
                                        <td >
                                            {{isset($date_from)? dateConvert($date_from).' - '.dateConvert($date_to): "All"}}  
                                    </td>
